 ...
 * 
 * Handles the oneof pattern for x and y values in protobuf
 */
 ...
 * 
 * This function recursively converts the protobuf Chart structure to our
 * cleaner TypeScript ChartTypes interface. It handles all chart types
 * including nested SuperCharts.
 * 
 * @param protoChart - Protobuf Chart object from gRPC response
 * @returns Converted ChartTypes object or undefined if invalid
 */
function convertProtoChart(protoChart?: ProtoChart): ChartTypes | undefined {
  ...
  // Construct the appropriate chart type based on type string
  switch (type) {
    case 'line':
    case 'scatter':
      return {
